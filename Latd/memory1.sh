...
PID="$(pidof oomkill)"
echo "-----------------------------------------------------------------------------------------------------------------" | tee -a /home/edge_computing/Documents/THESIS_SMITA/thesis/Results/memory1.txt
echo Individual Memory Statistics | tee -a /home/edge_computing/Documents/THESIS_SMITA/thesis/Results/memory1.txt
echo "-----------------------------------------------------------------------------------------------------------------" | tee -a /home/edge_computing/Documents/THESIS_SMITA/thesis/Results/memory1.txt
x=0
process_mem ()
{
...
do
	if [[ ! -d /proc/$PID ]];
  	then
		break       	   #If process doesn't exists.
  	fi

	process_mem
	sleep 0.1
done | tee -a /home/edge_computing/Documents/THESIS_SMITA/thesis/Results/memory1.txt
